...
function quizt(frame) {
  ...
  if (frame == 0) document.getElementById('f0').style = 'display: block';
  else if(frame == 1) document.getElementById('f1').style = 'display: block';
  ...
  else if(frame == 15) document.getElementById('f15').style = 'display: block'; 
  else if(frame == 16) document.getElementById('f16').style = 'display: block'; 
  else if(frame == 17) document.getElementById('f17').style = 'display: block'; 
  else alert('error');
}
